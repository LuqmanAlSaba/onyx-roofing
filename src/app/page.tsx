...
export default function Home() {
    ...
    const portfolioItems: WorkItem[] = [
        ...
        },
        {
            ...
            description: 'Onyx Roofing did a fantastic job for one of my clients who had just purchased a home that needed a new roof. The transformation was major — the look, quality, and workmanship really elevated the entire property.\n' +
                '\n' +
        ...
        const handleScroll = () => {
            if (!ticking) {
                window.requestAnimationFrame(() => {
                    ...
                    // Hide banner when scrolled more than 50px from the top
                    setPastVideoSection(scrollY > 30);
                    ticking = false;
                });
                ticking = true;
            }
    ...
    return (
        <div className="font-inter antialiased overflow-x-hidden"
            ...
            Call us at 502-207-3007
                ...
                {/* Gradient overlay for smooth transition to services section */}
                <div
                    className="absolute bottom-0 left-0 right-0 h-32 pointer-events-none z-10"
                    style={{
                        background: 'linear-gradient(to bottom, transparent 0%, #1a1f1a 100%)'
                    }}
                />
            ...
            <section id="services"
                ...
                <div className="absolute inset-0 opacity-30">
                    <div
                        className="absolute top-40 right-0 w-40 h-40 bg-[#40d6d1]/8 rounded-full blur-[100px] animate-pulse-slow"/>
                    <div
                        className="absolute bottom-0 left-0 w-50 h-50 bg-[#13938f]/10 rounded-full blur-[120px] animate-pulse-slower"/>
                </div>
