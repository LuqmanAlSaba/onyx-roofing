    ...
    return (
        <section className="my-16 relative overflow-hidden rounded-[2rem] border border-white/5 bg-[#1a1f1a]">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-stretch">
                {/* Photo */}
                <div className="relative w-full md:w-[220px] lg:w-[260px] shrink-0">
                    <div className="relative w-full h-[280px] md:h-full">
                        <Image
                            src="/ibrahim-maddie.webp"
                            alt="Ibrahim and Maddie Al-Saba"
                            fill
                ...
                {/* Text & Buttons */}
                <div className="p-8 md:p-12 flex flex-col items-start gap-6 flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        {onOpenForm ? (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                onClick={onOpenForm}
                                className="group relative flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#40d6d1] text-[#1a1f1a] transition-all duration-500 hover:bg-[#3bc2bd] shadow-[0_0_30px_-5px_rgba(64,214,209,0.3)] hover:shadow-[0_0_50px_-5px_rgba(64,214,209,0.5)] overflow-hidden whitespace-nowrap"
                            >
                                <span className="text-base font-medium relative z-10">{buttonText}</span>
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.98 }}
                            href="tel:5022073007"
                            className="group flex items-center justify-center gap-2 px-6 py-3 rounded-full border border-white/20 text-white hover:bg-white/5 transition-all duration-300 whitespace-nowrap"
                        >
                            ...
                            <span className="text-base font-medium">502-207-3007</span>
                        </motion.a>
                    </div>
                </div>
            </div>
